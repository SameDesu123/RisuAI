export const languageVietnamese = {
    ...
    apiUsageStatistics: {
        title: "Thống kê API",
        description: "Xem lượng token, chi phí ước tính và các yêu cầu thành công trên thiết bị này.",
        ...
        disclaimer: "Thống kê bắt đầu được ghi sau bản cập nhật này. Số token và giá chỉ là ước tính; token lưu đệm, giảm giá, công cụ, nội dung đa phương tiện, thuế và yêu cầu thiếu dữ liệu giá đáng tin cậy có thể chưa được tính.",
    },
    "subtitles": "Phụ đề",
