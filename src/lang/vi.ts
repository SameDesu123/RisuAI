export const languageVietnamese = {
    ...
    "help": {
        ...
        "databaseBlockStorageDesc": "Lưu các phần cơ sở dữ liệu, nhân vật và cuộc trò chuyện thành các tệp cục bộ riêng biệt, còn database.bin chỉ giữ một manifest nhỏ. Cách này tránh mã hóa toàn bộ cơ sở dữ liệu khi lưu cục bộ. Đây là tính năng thử nghiệm; đồng bộ tài khoản vẫn dùng định dạng một tệp cổ điển.",
    ...
    "databaseBlockStorage": "Lưu khối cơ sở dữ liệu cục bộ",
