export const languageVietnamese = {
    ...
    "help": {
        "modernDesktopTitleBar": "Sử dụng thanh tiêu đề hòa hợp với giao diện thay vì thanh tiêu đề mặc định của hệ điều hành. Tùy chọn này được lưu theo thiết bị. Thử nghiệm: các nút cửa sổ có thể hoạt động khác nhau tùy nền tảng.",
    ...
    "modernDesktopTitleBar": "Thanh tiêu đề desktop hiện đại",
    "titleBarToggleSidebar": "Bật/tắt thanh bên",
    "titleBarMinimize": "Thu nhỏ",
    "titleBarMaximize": "Phóng to",
    "titleBarRestore": "Khôi phục",
    "titleBarClose": "Đóng",
