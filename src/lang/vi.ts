export const languageVietnamese = {
    ...
    "help": {
        ...
        "botUiLua": "Mã Lua cho UI phủ của từng nhân vật. Định nghĩa renderUI(state) để trả về HTML đã được làm sạch, và tùy chọn onUIEvent(event, state) cho các phần tử có risu-ui-action. Chỉ render lại khi uiState thay đổi; inline JavaScript không được phép.",
