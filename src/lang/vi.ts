export const languageVietnamese = {
    ...
    apiUsageStatistics: {
        title: "Thống kê API",
        description: "Xem hoạt động yêu cầu LLM văn bản, lượng token và chi phí ước tính trên thiết bị này.",
        ...
        failed: "Thất bại",
        cancelled: "Đã hủy",
        chatRequests: "Trò chuyện",
        translationRequests: "Dịch thuật",
        auxiliaryRequests: "Phụ trợ",
        summaryPeriod: "Khoảng thống kê",
        ...
        customPricingDescription: "Đặt giá đầu vào và đầu ra cho chính xác một ID mô hình. Giá tùy chỉnh được ưu tiên hơn giá tích hợp.",
        customPricingFutureOnly: "Giá được tính bằng USD trên 1 triệu token và áp dụng cho các yêu cầu được ghi sau khi lưu. Các ước tính cũ không được tính lại.",
        modelId: "ID mô hình",
        pricePerMillion: "USD / 1 triệu token",
        savePrice: "Lưu giá",
        deletePrice: "Xóa giá",
        noCustomPricing: "Chưa có giá tùy chỉnh nào.",
        dailyActivity: "Hoạt động hằng ngày",
        heatmapDescription: "Ô đậm hơn biểu thị lượng token cao hơn.",
        less: "Ít",
        more: "Nhiều",
        unpriced: "chưa có giá",
        unpricedRequests: "yêu cầu chưa có dữ liệu giá",
        noActivity: "Không có hoạt động API nào được ghi nhận trong ngày này.",
        disclaimer: "Thống kê bắt đầu được ghi sau bản cập nhật này. Số yêu cầu bao gồm mọi chế độ LLM văn bản, lần thử lại, phương án dự phòng, yêu cầu tiếp theo của công cụ, lần thất bại và lần bị hủy. Số token và giá chỉ là ước tính; token lưu đệm, giảm giá, công cụ, nội dung đa phương tiện, thuế và yêu cầu thiếu dữ liệu giá đáng tin cậy có thể chưa được tính.",
    },
    "subtitles": "Phụ đề",
