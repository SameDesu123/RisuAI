export const languageVietnamese = {
    ...
    "help": {
        ...
        "modelUsageStatisticsLocalTokenizerFallback": "Tính nội dung lời nhắc và phản hồi hoàn tất ở cục bộ khi phản hồi của nhà cung cấp không có dữ liệu sử dụng.",
