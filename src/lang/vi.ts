export const languageVietnamese = {
    ...
    "help": {
        ...
        "streamingDisplayOptimization": "Nếu bật, văn bản chat đang stream sẽ được xử lý và vẽ lại theo tốc độ khung hình giới hạn thay vì theo từng chunk. Điều này có thể giảm tải trên thiết bị di động khi regex hoặc Markdown nặng.",
    ...
    "streamingDisplayOptimization": "Tối ưu hiển thị streaming",
    "streamingDisplayOptimizationLevel": "Mức tối ưu",
