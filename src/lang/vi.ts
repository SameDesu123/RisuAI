export const languageVietnamese = {
    botUiEnabled: "Bật Bot UI",
    botUiHelp: "Mở bảng HTML/CSS đã được làm sạch từ thanh công cụ chat. Nút Lua dùng {{button::Nhãn::TênHàm}} và dùng chung Lua trigger cùng trạng thái ChatVar hiện có.",
    botUiHtml: "Bot UI HTML",
    botUiCss: "Bot UI CSS",
    botUiOpenAction: "Hành động khi mở",
    botUiWidth: "Chiều rộng",
    botUiHeight: "Chiều cao",
    botUiOffsetX: "Độ lệch ngang",
    botUiOffsetY: "Độ lệch dọc",
    botUiAnchor: "Điểm neo bảng",
    botUiTopLeft: "Trên trái",
    botUiTopRight: "Trên phải",
    botUiBottomLeft: "Dưới trái",
    botUiBottomRight: "Dưới phải",
    botUiCenter: "Giữa",
    "formating": {
        "main": "Lời nhắc chính",
