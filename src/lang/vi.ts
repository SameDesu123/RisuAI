export const languageVietnamese = {
    ...
    "help": {
        ...
        "experimentalRequestLogViewer": "Sử dụng trình xem nhật ký yêu cầu kiểu Swagger thử nghiệm thay cho cửa sổ bật lên markdown cũ. Nếu trình xem mới không thể hiển thị, Risu sẽ tự động quay lại trình xem cũ.",
    ...
    "experimentalRequestLogViewer": "Trình xem nhật ký yêu cầu thử nghiệm",
    "menu": "Menu",
