export const languageSpanish = {
    ...
    "help": {
        ...
        "botUiLua": "Código Lua para una UI superpuesta por personaje. Define renderUI(state) para devolver HTML saneado y, opcionalmente, onUIEvent(event, state) para elementos con risu-ui-action. Solo se vuelve a renderizar cuando cambia uiState; no se permite JavaScript inline.",
