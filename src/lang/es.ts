export const languageSpanish = {
    ...
    "help": {
        "modernDesktopTitleBar": "Usa una barra de título integrada con el tema en lugar de la barra predeterminada del sistema operativo. La preferencia se guarda por dispositivo. Experimental: los botones de la ventana pueden comportarse diferente según la plataforma.",
