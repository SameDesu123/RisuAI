export const languageSpanish = {
    ...
    apiUsageStatistics: {
        title: "Uso de API",
        description: "Consulta las solicitudes de LLM de texto, el uso de tokens y el coste estimado de este dispositivo.",
        ...
        chatRequests: "Chat",
        translationRequests: "Traducción",
        auxiliaryRequests: "Auxiliares",
        summaryPeriod: "Periodo del resumen",
        ...
        customPricingDescription: "Define los precios de entrada y salida para un ID de modelo exacto. Los precios personalizados tienen prioridad.",
        customPricingFutureOnly: "Los precios están en USD por 1 millón de tokens y se aplican a solicitudes registradas después de guardar. Las estimaciones existentes no se recalculan.",
        modelId: "ID del modelo",
        pricePerMillion: "USD / 1 millón de tokens",
        savePrice: "Guardar precio",
        deletePrice: "Eliminar precio",
        noCustomPricing: "No se han añadido precios personalizados.",
        dailyActivity: "Actividad diaria",
        heatmapDescription: "Los cuadros más oscuros indican un mayor uso de tokens.",
        less: "Menos",
        more: "Más",
        unpriced: "sin precio",
        unpricedRequests: "solicitudes sin datos de precio",
        noActivity: "No se registró actividad de API en este día.",
        disclaimer: "Las estadísticas se registran a partir de esta actualización. El total incluye todos los modos de LLM de texto, reintentos, alternativas, solicitudes posteriores de herramientas y los intentos fallidos o cancelados. Los tokens y precios son estimaciones; puede que no incluyan tokens en caché, descuentos, herramientas, contenido multimedia, impuestos ni solicitudes sin precios fiables.",
    },
