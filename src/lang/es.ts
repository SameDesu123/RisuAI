export const languageSpanish = {
    botUiEnabled: "Activar Bot UI",
    botUiHelp: "Abre un panel HTML/CSS saneado desde la barra de chat. Los botones Lua usan {{button::Texto::NombreFuncion}} y comparten el Lua de activadores y el estado ChatVar existentes.",
    botUiHtml: "HTML de Bot UI",
    botUiCss: "CSS de Bot UI",
    botUiOpenAction: "Acción al abrir",
    botUiWidth: "Ancho",
    botUiHeight: "Alto",
    botUiOffsetX: "Desplazamiento horizontal",
    botUiOffsetY: "Desplazamiento vertical",
    botUiAnchor: "Anclaje del panel",
    botUiTopLeft: "Arriba izquierda",
    botUiTopRight: "Arriba derecha",
    botUiBottomLeft: "Abajo izquierda",
    botUiBottomRight: "Abajo derecha",
    botUiCenter: "Centro",
    "formating": {
