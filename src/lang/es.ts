export const languageSpanish = {
    ...
    "help": {
        ...
        "databaseBlockStorageDesc": "Guarda las secciones de la base de datos, los personajes y los chats como archivos locales separados, mientras database.bin conserva solo un manifiesto pequeño. Así evita codificar toda la base de datos en cada guardado local. La sincronización de cuenta sigue usando el formato clásico de un solo archivo.",
