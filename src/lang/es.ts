export const languageSpanish = {
    ...
    "help": {
        ...
        "experimentalRequestLogViewer": "Usa el visor experimental de registros de solicitudes con estilo Swagger en lugar de la ventana emergente markdown heredada. Si el nuevo visor no puede renderizarse, Risu volverá automáticamente al visor heredado.",
    ...
    "experimentalRequestLogViewer": "Visor experimental de registros de solicitudes",
    "menu": "Menú",
