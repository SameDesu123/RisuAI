export const languageSpanish = {
    ...
    apiUsageStatistics: {
        title: "Uso de API",
        description: "Consulta el uso de tokens, el coste estimado y las solicitudes correctas de este dispositivo.",
        ...
        disclaimer: "Las estadísticas se registran a partir de esta actualización. Los tokens y precios son estimaciones; puede que no incluyan tokens en caché, descuentos, herramientas, contenido multimedia, impuestos ni solicitudes sin precios fiables.",
    },
