export const languageSpanish = {
    ...
    "help": {
        ...
        "modelUsageStatisticsLocalTokenizerFallback": "Cuenta localmente el texto del prompt y de la respuesta completada cuando la respuesta del proveedor no incluye metadatos de uso.",
