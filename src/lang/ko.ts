export const languageKorean = {
    ...
    "help": {
        ...
        "botUiLua": "캐릭터별 오버레이 UI용 Lua 코드입니다. renderUI(state)를 정의해 sanitize된 HTML을 반환하고, risu-ui-action 요소 처리가 필요하면 onUIEvent(event, state)를 추가할 수 있습니다. uiState가 바뀔 때만 다시 렌더링되며 inline JavaScript는 허용되지 않습니다.",
