export const languageKorean = {
    ...
    apiUsageStatistics: {
        title: "API 요금 통계",
        description: "이 기기에서 사용한 토큰, 예상 비용, 성공한 요청 활동을 확인합니다.",
        totalTokens: "전체 토큰",
        estimatedCost: "예상 비용",
        requestCount: "요청 수",
        requests: "회 요청",
        ...
        disclaimer: "통계는 이 업데이트 이후부터 기록됩니다. 토큰 수와 가격은 추정치이며 캐시 토큰, 공급자 할인, 도구, 미디어, 세금 및 가격 정보를 확인할 수 없는 요청은 반영되지 않을 수 있습니다.",
    },
    "subtitles": "자막",
