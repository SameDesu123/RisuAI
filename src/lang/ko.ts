export const languageKorean = {
    ...
    "help": {
        ...
        "experimentalRequestLogViewer": "기존 마크다운 팝업 대신 실험적인 Swagger 스타일 리퀘스트 로그 뷰어를 사용합니다. 새 뷰어 렌더링에 실패하면 자동으로 기존 뷰어로 폴백합니다.",
    ...
    "experimentalRequestLogViewer": "실험적 리퀘스트 로그 뷰어",
