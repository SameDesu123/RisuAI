export const languageKorean = {
    ...
    "help": {
        ...
        "forcePluginFetchStreaming": "활성화되면 플러그인이 보내는 OpenAI 호환 Fetch 요청을 백그라운드에서 스트리밍으로 받고, 플러그인에는 일반 논스트리밍 응답처럼 반환합니다.",
        "streamingDisplayOptimization": "활성화되면 스트리밍 채팅 텍스트를 토큰을 받을 때마다 처리하지 않고 제한된 프레임 단위로 처리하고 다시 그립니다. 정규식 스크립트나 마크다운 렌더링이 무거울 때 모바일 오버헤드를 줄일 수 있습니다.",
    ...
    "forcePluginFetchStreaming": "플러그인 Fetch 강제 스트리밍",
    "streamingDisplayOptimization": "스트리밍 표시 최적화",
    "streamingDisplayOptimizationLevel": "최적화 강도",
