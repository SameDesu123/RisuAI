export const languageKorean = {
    botUiEnabled: "Bot UI 사용",
    botUiHelp: "채팅 도구 모음에서 정화된 HTML/CSS 패널을 엽니다. Lua 버튼은 {{button::표시명::함수명}} 형식을 사용하며 기존 트리거 Lua와 ChatVar 상태를 공유합니다.",
    botUiHtml: "Bot UI HTML",
    botUiCss: "Bot UI CSS",
    botUiOpenAction: "열 때 실행할 액션",
    botUiWidth: "너비",
    botUiHeight: "높이",
    botUiOffsetX: "가로 여백",
    botUiOffsetY: "세로 여백",
    botUiAnchor: "패널 기준 위치",
    botUiTopLeft: "왼쪽 위",
    botUiTopRight: "오른쪽 위",
    botUiBottomLeft: "왼쪽 아래",
    botUiBottomRight: "오른쪽 아래",
    botUiCenter: "가운데",
    "formating": {
        "main": "메인 프롬프트",
        "jailbreak": "탈옥 프롬프트",
