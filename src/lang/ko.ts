export const languageKorean = {
    ...
    "help": {
        ...
        "databaseBlockStorageDesc": "데이터베이스 항목, 캐릭터, 채팅을 각각 별도 로컬 파일로 저장하고 database.bin에는 작은 목록만 유지합니다. 로컬 저장 시 전체 데이터베이스 인코딩을 피할 수 있습니다. 계정 동기화는 기존 단일 파일 형식을 계속 사용합니다.",
