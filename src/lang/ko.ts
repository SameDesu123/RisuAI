export const languageKorean = {
    ...
    apiUsageStatistics: {
        title: "API 요금 통계",
        description: "이 기기에서 발생한 텍스트 LLM 요청의 토큰, 예상 비용, 요청 활동을 확인합니다.",
        totalTokens: "전체 토큰",
        estimatedCost: "예상 비용",
        requestCount: "요청 수",
        requests: "회 요청",
        ...
        cancelled: "취소",
        chatRequests: "채팅",
        translationRequests: "번역",
        auxiliaryRequests: "보조",
        summaryPeriod: "집계 기간",
        last7Days: "최근 7일",
        last30Days: "최근 30일",
        last90Days: "최근 90일",
        last365Days: "최근 365일",
        allTime: "전체 기간",
        customPricing: "커스텀 가격",
        customPricingDescription: "정확한 모델 ID에 입력·출력 단가를 지정합니다. 커스텀 단가는 내장 가격보다 우선합니다.",
        customPricingFutureOnly: "단가는 토큰 100만 개당 USD 기준이며 저장 후 기록되는 요청부터 적용됩니다. 기존 예상 가격은 다시 계산되지 않습니다.",
        modelId: "모델 ID",
        pricePerMillion: "USD / 토큰 100만 개",
        savePrice: "가격 저장",
        deletePrice: "가격 삭제",
        noCustomPricing: "등록된 커스텀 가격이 없습니다.",
        dailyActivity: "일별 활동",
        heatmapDescription: "토큰을 많이 사용할수록 타일이 진해집니다.",
        less: "적음",
        more: "많음",
        unpriced: "가격 미확인",
        unpricedRequests: "회의 가격 미확인 요청",
        noActivity: "이 날짜에 기록된 API 활동이 없습니다.",
        disclaimer: "통계는 이 업데이트 이후부터 기록됩니다. 요청 수에는 모든 텍스트 LLM 유형과 재시도, 폴백, 도구 후속 요청, 실패 및 취소된 시도가 포함됩니다. 토큰 수와 가격은 추정치이며 캐시 토큰, 공급자 할인, 도구, 미디어, 세금 및 가격 정보를 확인할 수 없는 요청은 반영되지 않을 수 있습니다.",
    },
    "subtitles": "자막",
