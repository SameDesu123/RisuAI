export const languageKorean = {
    ...
    "showHelp": "도움말 보기",
    "help": {
        "modernDesktopTitleBar": "운영체제 기본 상단 바 대신 테마와 어울리는 상단 바를 사용합니다. 이 설정은 기기별로 저장됩니다. 실험적 기능: 플랫폼에 따라 창 버튼이 다르게 동작할 수 있습니다.",
    ...
    "modernDesktopTitleBar": "모던 데스크톱 상단 바",
    "titleBarToggleSidebar": "사이드바 열기/닫기",
