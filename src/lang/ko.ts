export const languageKorean = {
    ...
    "help": {
        ...
        "emergencyBackup": "웹 저장 전체 인코딩 전에 최근 변경된 채팅을 별도 브라우저 로컬 저장소에 저장합니다. 다음 실행 때 더 최신 비상 복사본이 있으면 새 채팅으로 복구할 수 있습니다. 단, 백업 이후 원본 채팅이 달라진 경우 복구된 새 채팅에는 전체 내용이 아니라 변경된 부분만 들어갈 수 있습니다.",
    ...
    "emergencyBackup": {
        "recoveryPrompt": "Emergency backup에서 채팅 백업 {0}개, 변경된 메시지 {1}개를 찾았습니다.\n새 채팅으로 복구하거나, 현재 채팅을 먼저 확인하거나, 무시하고 백업 데이터를 삭제할 수 있습니다.",
        "recover": "복구",
        "check": "확인",
        "discard": "무시(삭제)",
        "discardConfirm": "선택한 Emergency backup 데이터를 무시하고 삭제할까요?",
        "discardConfirm2": "이 작업은 되돌릴 수 없습니다. Emergency backup 데이터를 정말 삭제할까요?",
