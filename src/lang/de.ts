export const languageGerman = {
    ...
    "help": {
        ...
        "botUiLua": "Lua-Code für eine charakterbezogene Overlay-UI. Definieren Sie renderUI(state), um bereinigtes HTML zurückzugeben, und optional onUIEvent(event, state) für Elemente mit risu-ui-action. Es wird nur neu gerendert, wenn sich uiState ändert; inline JavaScript ist nicht erlaubt.",
