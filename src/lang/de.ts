export const languageGerman = {
    ...
    apiUsageStatistics: {
        title: "API-Nutzung",
        description: "Token-Nutzung, geschätzte Kosten und erfolgreiche Anfragen auf diesem Gerät anzeigen.",
        ...
        disclaimer: "Die Statistik wird ab diesem Update aufgezeichnet. Token-Zahlen und Preise sind Schätzungen; Cache-Token, Rabatte, Werkzeuge, Medien, Steuern und Anfragen ohne verlässliche Preisdaten sind möglicherweise nicht enthalten.",
    },
