export const languageGerman = {
    ...
    apiUsageStatistics: {
        title: "API-Nutzung",
        description: "Text-LLM-Anfragen, Token-Nutzung und geschätzte Kosten auf diesem Gerät anzeigen.",
        ...
        chatRequests: "Chat",
        translationRequests: "Übersetzung",
        auxiliaryRequests: "Hilfsanfragen",
        summaryPeriod: "Auswertungszeitraum",
        ...
        customPricingDescription: "Eingabe- und Ausgabepreise für eine exakte Modell-ID festlegen. Benutzerdefinierte Preise haben Vorrang.",
        customPricingFutureOnly: "Preise gelten in USD pro 1 Mio. Token für Anfragen, die nach dem Speichern erfasst werden. Vorhandene Schätzungen werden nicht neu berechnet.",
        modelId: "Modell-ID",
        pricePerMillion: "USD / 1 Mio. Token",
        savePrice: "Preis speichern",
        deletePrice: "Preis löschen",
        noCustomPricing: "Es wurden keine benutzerdefinierten Preise hinzugefügt.",
        dailyActivity: "Tägliche Aktivität",
        heatmapDescription: "Dunklere Felder zeigen eine höhere Token-Nutzung.",
        less: "Weniger",
        more: "Mehr",
        unpriced: "ohne Preis",
        unpricedRequests: "Anfragen ohne Preisdaten",
        noActivity: "Für diesen Tag wurde keine API-Aktivität aufgezeichnet.",
        disclaimer: "Die Statistik wird ab diesem Update aufgezeichnet. Die Anfragezahl umfasst alle Text-LLM-Modi, Wiederholungen, Fallbacks, Werkzeug-Folgeanfragen sowie fehlgeschlagene und abgebrochene Versuche. Token-Zahlen und Preise sind Schätzungen; Cache-Token, Rabatte, Werkzeuge, Medien, Steuern und Anfragen ohne verlässliche Preisdaten sind möglicherweise nicht enthalten.",
    },
