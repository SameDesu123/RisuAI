export const languageGerman = {
    botUiEnabled: "Bot UI aktivieren",
    botUiHelp: "Öffnet ein bereinigtes HTML/CSS-Panel über die Chat-Werkzeugleiste. Lua-Schaltflächen verwenden {{button::Text::Funktionsname}} und teilen den vorhandenen Trigger-Lua- und ChatVar-Zustand.",
    botUiHtml: "Bot UI HTML",
    botUiCss: "Bot UI CSS",
    botUiOpenAction: "Aktion beim Öffnen",
    botUiWidth: "Breite",
    botUiHeight: "Höhe",
    botUiOffsetX: "Horizontaler Abstand",
    botUiOffsetY: "Vertikaler Abstand",
    botUiAnchor: "Panel-Anker",
    botUiTopLeft: "Oben links",
    botUiTopRight: "Oben rechts",
    botUiBottomLeft: "Unten links",
    botUiBottomRight: "Unten rechts",
    botUiCenter: "Mitte",
    "formating": {
