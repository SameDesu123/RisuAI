export const languageGerman = {
    ...
    "help": {
        ...
        "modelUsageStatisticsLocalTokenizerFallback": "Zählt Prompt- und abgeschlossenen Antworttext lokal, wenn die Anbieterantwort keine Nutzungsmetadaten enthält.",
