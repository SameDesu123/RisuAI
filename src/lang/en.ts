export const languageEnglish = {
    ...
    apiUsageStatistics: {
        title: "API Usage",
        description: "Review token usage, estimated cost, and text LLM request activity from this device.",
        ...
        customPricingDescription: "Set input and output rates for an exact model ID. Custom rates override built-in pricing.",
        customPricingFutureOnly: "Rates are in USD per 1M tokens and apply to requests recorded after saving. Existing estimates are not recalculated.",
        modelId: "Model ID",
        pricePerMillion: "USD / 1M tokens",
        savePrice: "Save price",
        deletePrice: "Delete price",
        noCustomPricing: "No custom pricing has been added.",
        dailyActivity: "Daily activity",
        heatmapDescription: "Darker tiles indicate more token usage.",
        less: "Less",
        more: "More",
        unpriced: "unpriced",
        unpricedRequests: "requests without pricing data",
        noActivity: "No API activity was recorded on this day.",
        disclaimer: "Statistics start after this update. Request counts include all text LLM modes, retries, fallbacks, tool follow-ups, failed attempts, and cancelled attempts. Token counts and prices are estimates; cached tokens, provider discounts, tools, media, taxes, and requests without reliable pricing data may not be reflected.",
    },
    subtitles: "Subtitles",
