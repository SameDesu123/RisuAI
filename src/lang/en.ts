export const languageEnglish = {
    botUiEnabled: "Enable Bot UI",
    botUiHelp: "Shows this sanitized HTML/CSS panel from the chat toolbar. Lua buttons use {{button::Label::FunctionName}} and share the character's existing trigger Lua and ChatVar state.",
    botUiHtml: "Bot UI HTML",
    botUiCss: "Bot UI CSS",
    botUiOpenAction: "Action to run when opened",
    botUiWidth: "Width",
    botUiHeight: "Height",
    botUiOffsetX: "Horizontal offset",
    botUiOffsetY: "Vertical offset",
    botUiAnchor: "Panel anchor",
    botUiTopLeft: "Top left",
    botUiTopRight: "Top right",
    botUiBottomLeft: "Bottom left",
    botUiBottomRight: "Bottom right",
    botUiCenter: "Center",
    formating: {
        main: "Main Prompt",
