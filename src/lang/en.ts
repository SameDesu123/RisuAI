export const languageEnglish = {
    ...
    help: {
        ...
        emergencyBackup: "Saves recently changed chats in a separate local browser store before the full web save is encoded. On the next launch, Risuai can offer to restore newer emergency copies as separate chats. If the original chat changed after the backup, recovery may include only the changed part instead of the full chat.",
    ...
    emergencyBackup: {
        recoveryPrompt: "Emergency backup found {0} chat backup(s), containing {1} changed message(s).\nYou can recover them as new chats, check your current chats first, or ignore and delete the backup data.",
        recover: "Recover",
        check: "Check",
        discard: "Ignore (Delete)",
        discardConfirm: "Ignore and delete the selected emergency backup data?",
        discardConfirm2: "This cannot be undone. Delete the emergency backup data?",
        disableConfirm: "Turning off Emergency Backup will delete existing emergency backup data. Continue?",
        disableConfirm2: "This cannot be undone. Turn off Emergency Backup and delete its data?",
    ...
    enableEmergencyBackup: "Emergency Backup",
