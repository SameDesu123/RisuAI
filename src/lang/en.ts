export const languageEnglish = {
    ...
    help: {
        ...
        emergencyBackup: "Saves recently changed chats in a separate local browser store before the full web save is encoded. On the next launch, Risuai can offer to restore newer emergency copies as separate chats.",
    ...
    emergencyBackup: {
        recoveryPrompt: "Emergency backup found {0} chat backup(s), containing {1} message(s). Recover them as new chats?",
        recover: "Recover",
        discard: "Discard",
        discardConfirm: "Discard the selected emergency backup data?",
        discardConfirm2: "This cannot be undone. Discard the emergency backup data?",
