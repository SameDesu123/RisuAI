export const languageChinese = {
    ...
    apiUsageStatistics: {
        title: "API 用量统计",
        description: "查看此设备上的文本 LLM 请求、Token 用量和预估费用。",
        ...
        cancelled: "已取消",
        chatRequests: "聊天",
        translationRequests: "翻译",
        auxiliaryRequests: "辅助",
        summaryPeriod: "统计周期",
        last7Days: "最近 7 天",
        last30Days: "最近 30 天",
        last90Days: "最近 90 天",
        ...
        allTime: "全部时间",
        customPricing: "自定义价格",
        customPricingDescription: "为准确的模型 ID 设置输入和输出单价。自定义价格优先于内置价格。",
        customPricingFutureOnly: "价格以每百万 Token 的美元计，仅适用于保存后记录的请求。不会重新计算已有估算。",
        modelId: "模型 ID",
        pricePerMillion: "USD / 百万 Token",
        savePrice: "保存价格",
        deletePrice: "删除价格",
        noCustomPricing: "尚未添加自定义价格。",
        dailyActivity: "每日活动",
        heatmapDescription: "Token 用量越多，方块颜色越深。",
        less: "较少",
        more: "较多",
        unpriced: "未计价",
        unpricedRequests: "次请求缺少价格数据",
        noActivity: "当天没有记录 API 活动。",
        disclaimer: "统计从本次更新后开始记录。请求数包含所有文本 LLM 模式、重试、回退、工具后续请求、失败及取消的尝试。Token 数和价格均为估算值；缓存 Token、服务商折扣、工具、媒体、税费以及缺少可靠价格数据的请求可能未被计入。",
    },
    "subtitles": "字幕",
