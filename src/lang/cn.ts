export const languageChinese = {
    ...
    "help": {
        ...
        "streamingDisplayOptimization": "启用后，流式聊天文本会按限制帧率处理和重绘，而不是每个分块都处理。正则脚本或 Markdown 渲染较重时可降低移动端开销。",
    ...
    "streamingDisplayOptimization": "流式显示优化",
    "streamingDisplayOptimizationLevel": "优化强度",
    "veryLow": "非常低",
    "low": "低",
    "medium": "中",
    "high": "高",
