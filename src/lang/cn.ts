export const languageChinese = {
    ...
    "help": {
        ...
        "botUiLua": "用于每个角色覆盖层 UI 的 Lua 代码。定义 renderUI(state) 返回经过清理的 HTML，也可以为带有 risu-ui-action 的元素定义 onUIEvent(event, state)。仅在 uiState 改变时重新渲染，不允许 inline JavaScript。",
