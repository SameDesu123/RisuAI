export const languageChineseTraditional = {
    ...
    apiUsageStatistics: {
        title: "API 用量統計",
        description: "查看此裝置上的文字 LLM 請求、Token 用量及預估費用。",
        ...
        cancelled: "已取消",
        chatRequests: "聊天",
        translationRequests: "翻譯",
        auxiliaryRequests: "輔助",
        summaryPeriod: "統計期間",
        last7Days: "最近 7 天",
        last30Days: "最近 30 天",
        last90Days: "最近 90 天",
        ...
        allTime: "全部期間",
        customPricing: "自訂價格",
        customPricingDescription: "為準確的模型 ID 設定輸入及輸出單價。自訂價格優先於內建價格。",
        customPricingFutureOnly: "價格以每百萬 Token 的美元計，僅適用於儲存後記錄的請求。不會重新計算現有估算。",
        modelId: "模型 ID",
        pricePerMillion: "USD / 百萬 Token",
        savePrice: "儲存價格",
        deletePrice: "刪除價格",
        noCustomPricing: "尚未新增自訂價格。",
        dailyActivity: "每日活動",
        heatmapDescription: "Token 用量越多，方塊顏色越深。",
        less: "較少",
        more: "較多",
        unpriced: "未計價",
        unpricedRequests: "次請求缺少價格資料",
        noActivity: "當天沒有記錄 API 活動。",
        disclaimer: "統計由本次更新後開始記錄。請求數包括所有文字 LLM 模式、重試、後備、工具後續請求、失敗及取消的嘗試。Token 數及價格均為估算值；快取 Token、供應商折扣、工具、媒體、稅項及缺少可靠價格資料的請求可能未被計入。",
    },
    "subtitles": "字幕",
