export const languageChineseTraditional = {
    ...
    "help": {
        ...
        "experimentalRequestLogViewer": "使用實驗性的 Swagger 風格請求記錄檢視器取代舊的 Markdown 彈窗。如果新檢視器渲染失敗，Risu 會自動回退到舊檢視器。",
    ...
    "experimentalRequestLogViewer": "實驗性請求記錄檢視器",
    ...
    "urlLabel": "URL",
    "headersLabel": "請求頭",
    "requestBodyLabel": "請求體",
    "responseBodyLabel": "響應體",
    "noBody": "無正文"
