export const languageChineseTraditional = {
    ...
    "help": {
        ...
        "botUiLua": "用於每個角色覆蓋層 UI 的 Lua 程式碼。定義 renderUI(state) 回傳已清理的 HTML，也可為帶有 risu-ui-action 的元素定義 onUIEvent(event, state)。僅在 uiState 改變時重新渲染，不允許 inline JavaScript。",
