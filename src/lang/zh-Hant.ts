export const languageChineseTraditional = {
    ...
    "help": {
        ...
        "streamingDisplayOptimization": "啟用後，串流聊天文字會按限制幀率處理和重繪，而不是每個分塊都處理。正則腳本或 Markdown 渲染較重時可降低行動裝置開銷。",
    ...
    "streamingDisplayOptimization": "串流顯示最佳化",
    "streamingDisplayOptimizationLevel": "最佳化強度",
