...
<main class="risu-app-shell flex bg-bg w-full h-full max-w-100vw text-textcolor" ondragover={(e) => {
    e.preventDefault()
    ...
    {:else}
        ...
        {:else}
            ...
            {:else}
                <div class="risu-mobile-sidebar z-30 flex flex-row items-center" class:fixed={$sideBarStore} class:hidden={!$sideBarStore} >
                    <!-- svelte-ignore a11y_click_events_have_key_events -->
