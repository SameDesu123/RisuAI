...
export const tauriOsType = isTauri ? tauriOs.type() : null
export const isTauriAndroid: boolean = tauriOsType === "android"
export const isTauriIOS: boolean = tauriOsType === "ios"
export const isTauriMobile: boolean = isTauriAndroid || isTauriIOS
