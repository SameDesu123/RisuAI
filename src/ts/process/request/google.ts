...
import { applyAdditionalRequestParams, applyParameters, getAdditionalRequestParams, type LLMParameter } from './shared'
...
export async function requestGoogleCloudVertex(arg:RequestDataArgumentExtended):Promise<requestDataResponse> {
    ...
    if(arg.aiModel === 'reverse_proxy' || arg.aiModel?.startsWith('xcustom:::')){
        body = applyAdditionalRequestParams(body, headers, getAdditionalRequestParams(arg.aiModel))
    }
